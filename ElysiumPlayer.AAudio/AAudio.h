 ...
 * Available since API level 26.
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t AAudio_createStreamBuilder(AAudioStreamBuilder** builder)
       ;
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setDeviceId(AAudioStreamBuilder* builder,
                                                int32_t deviceId);
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setSampleRate(AAudioStreamBuilder* builder,
                                                  int32_t sampleRate);
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setChannelCount(AAudioStreamBuilder* builder, int32_t channelCount);
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setSamplesPerFrame(AAudioStreamBuilder* builder,
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setFormat(AAudioStreamBuilder* builder,
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setSharingMode(AAudioStreamBuilder* builder,
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setDirection(AAudioStreamBuilder* builder,
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setBufferCapacityInFrames(AAudioStreamBuilder* builder,
        int32_t numFrames);
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setPerformanceMode(AAudioStreamBuilder* builder,
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setUsage(AAudioStreamBuilder* builder,
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setContentType(AAudioStreamBuilder* builder,
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setInputPreset(AAudioStreamBuilder* builder,
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setAllowedCapturePolicy(AAudioStreamBuilder* builder,
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setSessionId(AAudioStreamBuilder* builder,
 ...
 * false otherwise.
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setPrivacySensitive(AAudioStreamBuilder* builder,
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setDataCallback(AAudioStreamBuilder* builder,
 ...
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setFramesPerDataCallback(AAudioStreamBuilder* builder,
                                                             int32_t numFrames);
 ...
 *          to the callback functions.
 */
[DllImport(AAudioLib)] private static extern void AAudioStreamBuilder_setErrorCallback(AAudioStreamBuilder* builder,
 ...
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t  AAudioStreamBuilder_openStream(AAudioStreamBuilder* builder,
        AAudioStream** stream);
 ...
 * @return {@link #AAUDIO_OK} or a negative error.
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t  AAudioStreamBuilder_delete(AAudioStreamBuilder* builder);
 ...
 * @return {@link #AAUDIO_OK} or a negative error.
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t  AAudioStream_release(AAudioStream* stream) __INTRODUCED_IN(30);
 ...
 * @return {@link #AAUDIO_OK} or a negative error.
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t  AAudioStream_close(AAudioStream* stream);
 ...
 * @return {@link #AAUDIO_OK} or a negative error.
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t  AAudioStream_requestStart(AAudioStream* stream);
 ...
 * @return {@link #AAUDIO_OK} or a negative error.
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t  AAudioStream_requestPause(AAudioStream* stream);
 ...
 * @return {@link #AAUDIO_OK} or a negative error.
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t  AAudioStream_requestFlush(AAudioStream* stream);
 ...
 * @return {@link #AAUDIO_OK} or a negative error.
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t  AAudioStream_requestStop(AAudioStream* stream);
 ...
 * @param stream reference provided by AAudioStreamBuilder_openStream()
 */
[DllImport(AAudioLib)] private static extern aaudio_stream_state_t AAudioStream_getState(AAudioStream* stream);
 ...
 * @return {@link #AAUDIO_OK} or a negative error.
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t AAudioStream_waitForStateChange(AAudioStream* stream,
 ...
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t AAudioStream_read(AAudioStream* stream,
 ...
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t AAudioStream_write(AAudioStream* stream,
 ...
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t AAudioStream_setBufferSizeInFrames(AAudioStream* stream,
        int32_t numFrames);
 ...
 */
[DllImport(AAudioLib)] private static extern int32_t AAudioStream_getBufferSizeInFrames(AAudioStream* stream);
 ...
 * @return burst size
 */
[DllImport(AAudioLib)] private static extern int32_t AAudioStream_getFramesPerBurst(AAudioStream* stream);
 ...
 */
[DllImport(AAudioLib)] private static extern int32_t AAudioStream_getBufferCapacityInFrames(AAudioStream* stream);
 ...
 */
[DllImport(AAudioLib)] private static extern int32_t AAudioStream_getFramesPerDataCallback(AAudioStream* stream);
 ...
 */
[DllImport(AAudioLib)] private static extern int32_t AAudioStream_getXRunCount(AAudioStream* stream);
 ...
 */
[DllImport(AAudioLib)] private static extern int32_t AAudioStream_getSampleRate(AAudioStream* stream);
 ...
 */
[DllImport(AAudioLib)] private static extern int32_t AAudioStream_getChannelCount(AAudioStream* stream);
 ...
 */
[DllImport(AAudioLib)] private static extern int32_t AAudioStream_getSamplesPerFrame(AAudioStream* stream);
 ...
 */
[DllImport(AAudioLib)] private static extern int32_t AAudioStream_getDeviceId(AAudioStream* stream);
 ...
 */
[DllImport(AAudioLib)] private static extern aaudio_format_t AAudioStream_getFormat(AAudioStream* stream);
 ...
 */
[DllImport(AAudioLib)] private static extern aaudio_sharing_mode_t AAudioStream_getSharingMode(AAudioStream* stream)
       ;
 ...
 * @param stream reference provided by AAudioStreamBuilder_openStream()
 */
[DllImport(AAudioLib)] private static extern aaudio_performance_mode_t AAudioStream_getPerformanceMode(AAudioStream* stream)
       ;
 ...
 * @return direction
 */
[DllImport(AAudioLib)] private static extern aaudio_direction_t AAudioStream_getDirection(AAudioStream* stream);
 ...
 */
[DllImport(AAudioLib)] private static extern int64_t AAudioStream_getFramesWritten(AAudioStream* stream);
 ...
 * @return frames read
 */
[DllImport(AAudioLib)] private static extern int64_t AAudioStream_getFramesRead(AAudioStream* stream);
 ...
 */
[DllImport(AAudioLib)] private static extern aaudio_session_id_t AAudioStream_getSessionId(AAudioStream* stream) __INTRODUCED_IN(28);
 ...
 * @return {@link #AAUDIO_OK} or a negative error
 */
[DllImport(AAudioLib)] private static extern aaudio_result_t AAudioStream_getTimestamp(AAudioStream* stream,
 ...
 * @return frames read
 */
[DllImport(AAudioLib)] private static extern aaudio_usage_t AAudioStream_getUsage(AAudioStream* stream) __INTRODUCED_IN(28);
 ...
 */
[DllImport(AAudioLib)] private static extern aaudio_content_type_t AAudioStream_getContentType(AAudioStream* stream)
        __INTRODUCED_IN(28);
 ...
 */
[DllImport(AAudioLib)] private static extern aaudio_input_preset_t AAudioStream_getInputPreset(AAudioStream* stream)
        __INTRODUCED_IN(28);
 ...
 */
[DllImport(AAudioLib)] private static extern aaudio_allowed_capture_policy_t AAudioStream_getAllowedCapturePolicy(
 ...
 */
[DllImport(AAudioLib)] private static extern bool AAudioStream_isPrivacySensitive(AAudioStream* stream)
        __INTRODUCED_IN(30);
